...
import { FaCar, FaDollarSign, FaClock } from "react-icons/fa";
  ...
  return (
    <div className="container mx-auto py-16 px-4">
      ...
      <motion.div initial="hidden" animate="show" variants={fadeInUp} className="text-center mb-12">
        ...
        <p className="text-xl mt-4 text-gray-700 max-w-3xl mx-auto">
          At PolishPro, we’re dedicated to bringing out the shine in your vehicle. Experience top-notch car wash services that exceed expectations.
        </p>
      </motion.div>
      ...
      >
        {[ 
          { icon: FaCar, title: "5000+ Cars Cleaned", text: "We've serviced thousands of vehicles with care." },
          { icon: FaDollarSign, title: "Affordable Prices", text: "Quality service without breaking the bank." },
          { icon: FaClock, title: "Quick Service", text: "Get your car washed in under an hour!" },
        ].map((item, index) => (
          <motion.div
            key={index}
            whileHover={{ scale: 1.05, rotate: 3 }}
      ...
      <motion.div initial="hidden" animate="show" variants={staggerContainer} className="text-center my-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {[ 
            { name: "John Doe", role: "Founder & CEO", img: profilePic1 },
            { name: "Jane Smith", role: "Operations Manager", img: profilePic2 },
            { name: "Michael Brown", role: "Lead Technician", img: profilePic3 },
      ...
      <motion.div initial="hidden" animate="show" variants={fadeInUp} className="my-16">
        ...
        <div className="flex flex-wrap justify-center">
          {[ 
            {
              name: "Alice Johnson",
              feedback: "PolishPro did an amazing job on my car! It looks brand new, and the service was fast and friendly.",
              img: profilePic1
            },
            {
              name: "Mark Smith",
              feedback: "I love how affordable and quick their service is. Highly recommend PolishPro!",
              img: profilePic2
            },
            {
              name: "Emma Brown",
              feedback: "The team at PolishPro truly cares about their customers. Best car wash experience I've ever had!",
              img: profilePic3
            },
          ].map((testimonial, index) => (
            <motion.div
